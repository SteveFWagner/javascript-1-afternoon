...
//Code Here
var finalGreeting = (name2) => "Hello, " + name2;
...
//Code Here
function checkChocolate(item){
  return item === "chocolate";
}
function doubleCheck(arr){
  if(arr.every(checkChocolate)==true){
    return arr;
  }
  else{
    arr.push("chocolate")
...
//Code Here
var name123 = function(){return "Steve Wagner"};
